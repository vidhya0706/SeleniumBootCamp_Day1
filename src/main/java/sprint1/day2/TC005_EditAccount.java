...
//10)Enter Billing Address
		driver.findElement(By.xpath("//textarea[@name='street']")).sendKeys("66A west ponnagaram, madurai");
//11)Enter Shipping Address
		driver.findElement(By.xpath("(//textarea[@name='street'])[2]")).sendKeys("66A west ponnagaram, madurai");
...
//15) Enter Unique Number in Phone Field
		driver.findElement(By.xpath("//input[@name='Phone']")).sendKeys("9845439348");
